...
public record AnimeLogProperties(
    ...
    /** Bangumi 配置：工作目录、任务执行器开关、锁超时时间、标签导入最低 count 阈值。 */
    public record Bangumi(String workDir, boolean taskRunnerEnabled, long taskRunnerLockSeconds, int tagMinCount) {
    }
